...
class WhatsAppService:
    ...
    def send_health_card(
        ...
        """
        try:
            # Generate enhanced recommendation text
            from app.utils.report_formatter import format_enhanced_recommendation
            
            enhanced_message = format_enhanced_recommendation(
                result, 
                language=language, 
                include_contacts=True
            )
            
            # Try to generate health card image
            ...
            if card_path:
                ...
                return self.send_media(to, enhanced_message, card_url)
            else:
                # Fallback to text message with enhanced formatting
                return self.send_text(to, enhanced_message)
